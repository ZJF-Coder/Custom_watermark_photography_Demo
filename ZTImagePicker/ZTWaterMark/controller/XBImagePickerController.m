...
//    if(self.canRotate) self.canRotate = NO;
    ...
    self.pageLb.frame = CGRectMake(self.view.width  - 65, self.view.height - 30 - buttomBarHeight, 50, 25);
...
//    if(self.canRotate) return;
    ...
    if([UIDevice currentDevice].orientation == UIDeviceOrientationLandscapeLeft && !self.canRotate){
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            self.pageLb.frame = CGRectMake(5, self.view.height - (70* [UIScreen mainScreen].bounds.size.width/320.0)-60, 25, 50);
...
- (UITextField *)pageLb{
    if(_pageLb == nil){
        ...
        _pageLb.frame = CGRectMake(self.view.width  - 65, self.view.height - 30 - 101, 50, 25);
...
{
    [_scrollView setDefaultPlacemark:[NSString stringWithFormat:@"%f",longitude] departMentplaceMark:[NSString stringWithFormat:@"%f",latitude] andUserNameString:userNameString andAddressString:addressString andActionString:actionString];
}

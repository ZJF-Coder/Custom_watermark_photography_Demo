...
- (void)layoutSubviews{
    ...
    _photoLibraryButton.frame = CGRectMake(20, 0, 30, 30);
    _photoLibraryButton.centerY = _buttomBar.height / 2.0;
...
- (UIButton *)photoLibraryButton
{
    if (!_photoLibraryButton) {
        ...
        [_photoLibraryButton setImage:[UIImage imageNamed:@"photoImage"] forState:0];
        [_buttomBar addSubview:_photoLibraryButton];
    }
